...
const startStr = "{/* Step 2: Measuring */}";
const endStr = "{/* Step 3: Results */}";
...
const patchedCode = code.substring(0, startIndex) + newMeasuringStep + code.substring(endIndex);
fs.writeFileSync('src/components/CalibrationWizard.tsx', patchedCode);
