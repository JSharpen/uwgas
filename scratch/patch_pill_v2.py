...
# The original Summary Pill code starts at:
...
""" + original_pill + """
              ...
              <div 
                className={`relative z-10 pointer-events-auto w-full ${isSetupPanelOpen ? 'neu-convex-pressed' : 'neu-convex neu-convex-active'} shrink-0 border border-black/20 rounded-3xl flex flex-col items-center justify-center p-4 sm:p-5 transition-all overflow-hidden`}
              >
