...
export function ContextBarShell() {
  ...
  if (confirmation) {
    return (
      <>
        ...
        <header ref={headerRef} className="touch-none fixed top-3 sm:top-4 left-3 right-3 sm:left-auto sm:right-auto sm:w-[576px] z-50 flex items-center justify-between bg-[#09090b] border border-red-500/30 rounded-3xl ring-1 ring-red-500/20 shadow-[0_4px_12px_rgba(239,68,68,0.15)] transition-all duration-300 mx-auto p-2">
  ...
  return (
    <>
      <div className="w-full shrink-0" style={{ height: `calc(${headerActualHeight}px + var(--card-stack-gap, 12px) - 1rem)` }} />
      <header ref={headerRef} className="touch-none fixed top-3 sm:top-4 left-3 right-3 sm:left-auto sm:right-auto sm:w-[576px] z-50 flex items-center justify-between bg-[#09090b] border border-amber-500/30 ring-1 ring-amber-500/20 shadow-[0_4px_12px_rgba(245,158,11,0.15)] rounded-3xl transition-all duration-300 mx-auto p-2">
